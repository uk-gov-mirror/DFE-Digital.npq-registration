...
class RegistrationWizard
  ...
  def answers
    ...
    array << Answer.new("Working in England", teacher_catchment_humanized, :teacher_catchment) if store["teacher_catchment"].present? # TODO: test
...
private
  ...
  def institution_from_store
    @institution_from_store ||= query_store.institution
  end
